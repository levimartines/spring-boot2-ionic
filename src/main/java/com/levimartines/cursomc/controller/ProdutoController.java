...
import com.levimartines.cursomc.bean.ProdutoBean;
import com.levimartines.cursomc.controller.utils.URL;
import com.levimartines.cursomc.model.Produto;
import com.levimartines.cursomc.service.ProdutoService;
...
public class ProdutoController {
    ...
    public ResponseEntity<Page<ProdutoBean>> findPage(
        ...
        Page<ProdutoBean> listDto = list.map(ProdutoBean::new);
