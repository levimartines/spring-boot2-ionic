...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.levimartines.cursomc.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
            ...
            "Esta API é utilizada no curso de Spring Boot 2 do prof. Nelio Alves",
            "Versão 1.0",
            "https://www.udemy.com/terms",
            new Contact("Levi Martines", "https://github.com/levimartines",
